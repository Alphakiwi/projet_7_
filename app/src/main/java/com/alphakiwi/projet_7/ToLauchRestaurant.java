...
public class ToLauchRestaurant extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_lauch_restaurant);
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(mLayout, "Location access is required to display restaurants near you.",
                ...
                public void onClick(View view) {
                    ...
                    ActivityCompat.requestPermissions(ToLauchRestaurant.this,
